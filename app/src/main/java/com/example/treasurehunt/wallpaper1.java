...
public class wallpaper1 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstPage = findViewById(R.id.thisPage);
        firstPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(wallpaper1.this, "1/3", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        secondPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(wallpaper1.this, wallpaper2.class);
                startActivity(intent);
                Toast.makeText(wallpaper1.this, "2/3", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        thirdPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(wallpaper1.this, wallpaper3.class);
                startActivity(intent);
                Toast.makeText(wallpaper1.this, "3/3", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        void onSwipeRight() {
            Intent intent = new Intent(wallpaper1.this, MainActivity.class);
            startActivity(intent);
            finish();
